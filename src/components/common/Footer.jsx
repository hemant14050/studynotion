...
const Footer = () => {
  return (
    <div className='bg-richblack-800 mx-auto w-full'>
        <div className='w-11/12 mx-auto flex flex-col gap-10 max-w-maxContent pt-14 pb-6 text-richblack-400'>
            ...
            <div className='mx-auto text-center flex justify-center flex-col md:flex-row border-t border-richblack-600 w-full pt-5 gap-[.5rem]'>
                <p>Made with ❤️ by 
